...
const MAX_GUESTS = 15; 
const BASE_GUESTS = 12; // New constant for the base included pax
const EXTRA_GUEST_FEE = 300.00; // New constant for the extra pax fee
const MIN_ADULTS = 1;
...
// Updated: Accepts modal ID to close either receipt or guest modal
...
function updateGuestCounts(type, action) {
    ...
    // Update the visual display inside the modal
    document.getElementById(`${type}Count`).textContent = count;
    
    // Update button states
    updateGuestButtonStates();

    // Update the summary display in the main booking step and recalculate total
